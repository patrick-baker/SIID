        ...
        return (
            ...
            <div>
                {/*conditionally rendered based on form selected goal*/}
                {
                    ...
                    <><h2 className='report__header2'>Campaign Goals: <span style={{ color: '#5B63DA' }}>Lead Generation</span></h2>
...

                {
                    ...
                    <><h2 className="report__header2">Campaign Goals: <span style={{ color: '#5B63DA' }}>Sales Enablement</span></h2>
                        <table className="report__toneTable">
        ...
        
                {
                    ...
                    <><h2 className="report__header2">Campaign Goals: <span style={{ color: '#5B63DA' }}>Audience Engagement</span></h2>
                                <table className="report__toneTable">
                                    <tr><td className="label">Social Shares:</td><td className="datum">{this.props.reportReducer.goals_social_shares}</td></tr>
